...
echo '  </script>';
                    ...
                    <tr>
						...
						<input type="button" value="Purchase Items" class="btn btn-primary" onclick="window.location='purchase.php?email=<?php echo $email ?>&invoice=<?php echo $_GET['invoice'] ?>&customer=<?php echo $_GET['user1'] ?>'" >
                      </div>
                    </div>
                  </div>
                </div>
