...
.btn-primary, .btn-default, buttons-print {
	...
	border:1px solid #000;
      ...
      <script type="text/javascript" src="https://cdn.jsdelivr.net/jsbarcode/3.5.1/JsBarcode.all.min.js"></script>
          ...
          // session_start(); // Uncomment if session is not started
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    <div class="modal-header" style="background:#347928">
...
reader.readAsDataURL(file);});
                      ...
                      <div class="form-group row">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">Type of Quantity</label>
                        <div class="col-md-9 col-sm-9 col-xs-9">
							<select name="type_quantity" required class="form-control">
								<option><option>
