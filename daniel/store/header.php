      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;;width:100%;border:0px solid red;height:150px">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu" style="margin-top:100px">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="product.php"><i class="fa-solid fa-list"  style="font-size:20px"></i> &nbsp;Product List</a></li>
                  <li><a href="sale.php"><i class="fa-solid fa-list"  style="font-size:20px"></i> &nbsp;Sales</a></li>
                  <li><a href="pos.php"><i class="fa-solid fa-bullseye-pointer" style="font-size:20px"></i> &nbsp;POS</a></li>
                  <li><a href="sales.php"><i class="fa-solid fa-money-bill" style="font-size:20px"></i> &nbsp;Sales Report</a></li>
