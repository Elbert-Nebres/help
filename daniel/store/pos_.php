...
if (isset($_POST['submit'])) {
  ...
  if ($quantity > $quan) {
    echo '<script>alert("You can only purchase ' . $quan . ' pieces of this item"); window.location="pos_.php";</script>';
} else {
      $all = $quan - $quantity;
      $status = 'Pending';
...
?>
            ...
            <form action="#" method="POST" onsubmit="this.submitButton.disabled=true; this.submit();">
    <input type="submit" name="submit" value="Add product" class="btn btn-primary" id="submitButton">
            </form>
						</tr>
					  </table>
					 </form>
