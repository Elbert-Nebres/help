...
<div class="row" style="margin-top:20px">
  ...
  <div class="col-sm-4">
    <div class="card" style="background:#2A3F54">
      <div class="card-body">
	  <h1  style="color:#FFF" ><i class="fa-solid fa-users"></i>&nbsp;<?php echo $count3 ?></h1>
        <h5  style="color:#FFF" class="card-title">Total Number of Registered Users</h5>
      </div>
    </div>
  </div>
  <div class="col-sm-4">
    <div class="card" style="background:#2A3F54">
      <div class="card-body">
	  <h1  style="color:#FFF"><i class="fa-solid fa-square-poll-vertical"></i>&nbsp;<?php echo $count4 ?></h1>
...
Highcharts.chart('con', {
    ...
    title: {
        text: 'Most Sold Items Batangas Branch'
    },
    yAxis: {
        allowDecimals: false,
        title: {
...
Highcharts.chart('con1', {
    ...
    title: {
        text: 'Most Sold Items Dasmariñas Cavite Branch'
    },
    yAxis: {
        allowDecimals: false,
        title: {
...
Highcharts.chart('con3', {
    ...
    title: {
        text: 'Most Sold Items Taysan Batangas Branch'
    },
    yAxis: {
        allowDecimals: false,
        title: {
